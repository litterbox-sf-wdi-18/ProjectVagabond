...
u1 = User.create(first_name:"Joe", last_name:"Schmoe", home_city:"San Francisco", email:"joe@mail.com", password:"password")
u2 = User.create(first_name:"Bob", last_name:"Jones", home_city:"New York", email:"bob@mail.com", password:"password")
u3 = User.create(first_name:"Sue", last_name:"Smith", home_city:"Chicago", email:"sue@mail.com", password:"password")
u4 = User.create(first_name:"Don", last_name:"Ho", home_city:"Honolulu", email:"don@mail.com", password:"password")
u5 = User.create(first_name:"Betty", last_name:"Hosehead", home_city:"Toronto", email:"betty@mail.com", password:"password")
u6 = User.create(first_name:"Julia", last_name:"Mozzarella", home_city:"Rome", email:"julia@mail.com", password:"password")
u7 = User.create(first_name:"Mary", last_name:"Brown", home_city:"Sydney", email:"mary@mail.com", password:"password")
u8 = User.create(first_name:"Jorge", last_name:"Villalobos", home_city:"Barcelona", email:"jorge@mail.com", password:"password")
u9 = User.create(first_name:"Hans", last_name:"Gruber", home_city:"Berlin", email:"hiro@mail.com", password:"password")
